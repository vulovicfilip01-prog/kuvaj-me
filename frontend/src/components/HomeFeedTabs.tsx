        ...
        <section className="py-12 md:py-20 bg-gradient-to-b from-white to-orange-50/30">
            <div className="container mx-auto px-6">
                ...
                <div className="flex flex-col md:flex-row items-center justify-between mb-12 gap-6">
                    <div className="glass-panel p-1.5 rounded-full flex gap-1 shadow-md overflow-x-auto whitespace-nowrap hide-scrollbar max-w-full">
                        <button
                            onClick={() => setActiveTab('trending')}
                            className={`flex-shrink-0 flex items-center gap-2 px-6 py-3 rounded-full font-bold transition-all cursor-pointer ${activeTab === 'trending'
                        ...
                        {isAuthenticated && (
                            <button
                                ...
                                className={`flex-shrink-0 flex items-center gap-2 px-6 py-3 rounded-full font-bold transition-all cursor-pointer ${activeTab === 'feed'
                        ...
                        <button
                            ...
                            className={`flex-shrink-0 flex items-center gap-2 px-6 py-3 rounded-full font-bold transition-all cursor-pointer ${activeTab === 'newest'
                                ? 'bg-gradient-to-r from-primary to-primary-dark text-white shadow-lg'
                                : 'text-slate-600 hover:text-primary hover:bg-green-50'
                                }`}
                        >
